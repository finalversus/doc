...
// ToGoImage converts the Document Image to a golang Image structure.
...
type ImageHandler interface {
	...
	// NewImageFromGoImage loads a RGBA Document Image from a standard Go image structure.
	NewImageFromGoImage(goimg goimage.Image) (*Image, error)

	// NewGrayImageFromGoImage loads a grayscale Document Image from a standard Go image structure.
...
// NewImageFromGoImage creates a new RGBA Document Image from a golang Image.
...
// NewGrayImageFromGoImage creates a new grayscale Document Image from a golang Image.
