...
func TestStyledLinkRotation(t *testing.T) {
	...
	p := c.NewStyledParagraph()
	p.AddExternalLink("Link with no rotation", "https:")
	p.SetPos(50, 50)
	...
	p = c.NewStyledParagraph()
	p.AddExternalLink("Link rotated 45 degrees", "https:")
	p.SetAngle(45)
	p.SetPos(200, 100)
	...
	p = c.NewStyledParagraph()
	p.AddExternalLink("Link rotated 90 degrees", "https:")
	p.SetAngle(90)
	p.SetPos(50, 250)
	...
	p = c.NewStyledParagraph()
	p.AddExternalLink("Link rotated 180 degrees", "https:")
	p.SetAngle(180)
	p.SetPos(250, 150)
	...
	p = c.NewStyledParagraph()
	p.AddExternalLink("Link rotated 225 degrees", "https:")
	p.SetAngle(225)
	p.SetPos(375, 150)
	...
	p = c.NewStyledParagraph()
	p.AddExternalLink("Link rotated 135 degrees", "https:")
	p.SetAngle(135)
	p.SetPos(525, 230)
