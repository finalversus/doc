...
// Note: Is a copy from internal/textencoding/simple.go, needed to avoid import cycles.
// TODO: In the future may be better to define an import-free package containing all encodingdata.
